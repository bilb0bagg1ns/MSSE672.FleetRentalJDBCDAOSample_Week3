package com.fleetrentaljdbcdaosample.model.services.manager;
 ...
 *
 * For example: 1. The application.properties file that was loaded for this
 * application has these values: jdbc.url = jdbc:odbc:TimeZone jdbc.user = Homer
 * jdbc.password = Duff 2. Once this file is loaded, if a class wants to get the
 * value for the key jdbc.url, you would make the following call:
 * PropertyManager.getPropertyValue("jdbc.url"); This would return the string
 * value, "jdbc:odbc:TimeZone"
 *
 * @author Mike.Prasad
 *
 */
